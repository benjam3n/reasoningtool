# DETECTING SELF-DECEPTION PROCEDURE

**A mechanical procedure for recognizing when you are rationalizing rather than reasoning**

Generated by: DCP (Decision Procedure) chain
Date: 2026-01-31
Chain: /dd -> /se -> /aex -> /stg -> /fla -> /pv
...
This is a step-by-step procedure for catching yourself in the act of motivated reasoning -- when your "analysis" is actually a post-hoc justification for a decision you have already emotionally made. It is written so that someone with zero background in psychology or critical thinking can follow every step mechanically and arrive at an honest assessment of whether they are deceiving themselves.
...
# DCP CHAIN EXECUTION LOG

## STEP 1/6: DIMENSION DISCOVERY (/dd)

### Seed Examples of Self-Deception

1. Buying an expensive car and telling yourself it is a "smart investment"
2. Staying in a bad relationship and calling it "loyalty"
3. Not applying for a job and calling it "not the right time"
4. Eating junk food and saying "I deserve a treat" for the fifth day running
5. Ignoring a doctor's advice and saying "they are being overly cautious"
6. Choosing the easy option at work and framing it as "strategic prioritization"
7. Dismissing criticism by attacking the critic's credibility
8. Googling only for evidence that supports what you already believe
9. Sunk-cost reasoning: "I've already put so much into this"
10. Refusing to update a belief after new evidence because "that study is flawed"

### Dimensions Discovered

| # | Dimension | Values | Why It Matters |
|---|-----------|--------|----------------|
| 1 | **Timing** | Pre-decision, mid-decision, post-decision, recurring | Self-deception operates differently at each stage |
| 2 | **Emotional driver** | Fear, desire, pride, shame, comfort, anger, attachment | The hidden emotion powering the rationalization |
| 3 | **Mechanism** | Selective attention, cherry-picking evidence, moving goalposts, false framing, minimization, projection, sunk-cost anchoring | The specific cognitive trick being used |
| 4 | **Stakes** | Low (lunch choice), Medium (purchase), High (career/relationship), Existential (health/safety) | Higher stakes = stronger self-deception |
| 5 | **Awareness level** | Fully blind (no idea you are doing it), Suspicious (nagging feeling), Semi-aware (you know but won't look), Caught (mid-act recognition) | Determines which intervention works |
| 6 | **Social context** | Solo decision, influenced by others, group consensus, adversarial (someone is challenging you) | Social pressure amplifies self-deception |
| 7 | **Reversibility** | Easily reversible, costly to reverse, irreversible | Urgency of catching the deception |
| 8 | **Evidence availability** | Abundant data exists, some data exists, unknowable, data exists but you haven't looked | Whether you CAN check your reasoning |
| 9 | **Identity involvement** | Low (preference), Medium (values), High (core identity, "who I am") | The more identity-involved, the stronger the self-deception |
| 10 | **Argument quality** | No argument (just a feeling), Weak argument (one reason), Moderate (several reasons), Elaborate (suspiciously thorough) | Paradoxically, more elaborate arguments may signal more self-deception |

TOTAL SPACE: 4 x 7 x 7 x 4 x 4 x 4 x 3 x 4 x 4 x 4 = 7,225,344 combinations
Granularity: REPRESENTATIVE (using hierarchical approach given space size)

---

## STEP 2/6: SPACE ENUMERATION (/se)

### Organized by Mechanism (the specific trick your mind is playing)

#### Mechanism 1: Selective Attention
- **What it looks like**: You notice and remember information that supports your preferred conclusion. You skim past or forget information that contradicts it.
- **Common phrases**: "All the evidence points to...", "Everyone agrees that...", "It's obvious that..."
- **Test**: Can you state the three strongest arguments AGAINST your position from memory? If not, you have been selectively attending.

#### Mechanism 2: Cherry-Picking Evidence
- **What it looks like**: You actively search for supporting evidence. You evaluate supporting evidence uncritically ("great study!") and opposing evidence harshly ("flawed methodology").
- **Common phrases**: "Research shows...", "I looked into it and...", "The data supports..."
- **Test**: Did you search for evidence that would DISPROVE your position with the same energy you searched for supporting evidence?

#### Mechanism 3: Moving Goalposts
- **What it looks like**: When your original justification is challenged, you shift to a different justification without acknowledging the shift.
- **Common phrases**: "Well, the real reason is...", "What I actually meant was...", "That's not the point..."
- **Test**: Write down your reason BEFORE any discussion. After the discussion, check: is it the same reason?

#### Mechanism 4: False Framing
- **What it looks like**: You describe the situation using language that makes your preferred choice sound rational. "Investment" instead of "expense." "Boundary" instead of "avoidance."
- **Common phrases**: Using euphemisms, reframing costs as benefits, describing inaction as action
- **Test**: Describe your decision using the least flattering but still accurate language. Does your reasoning still hold?

#### Mechanism 5: Minimization
- **What it looks like**: You downplay the risks, costs, or downsides of your preferred choice. "It's not that bad." "It probably won't happen."
- **Common phrases**: "The worst case isn't that bad...", "It's only...", "Just this once..."
- **Test**: Would you accept the same minimization from someone else about something that affects YOU negatively?

#### Mechanism 6: Projection / Ad Hominem
- **What it looks like**: Instead of engaging with the content of criticism, you attack the source. "They're just jealous." "They don't understand."
- **Common phrases**: "Consider the source...", "They have their own agenda...", "Easy for them to say..."
- **Test**: If the exact same criticism came from someone you deeply respect, would you still dismiss it?

#### Mechanism 7: Sunk-Cost Anchoring
- **What it looks like**: You continue with a course of action because of what you have already invested, not because the path forward is good.
- **Common phrases**: "I've already put so much into this...", "It would be a waste to stop now...", "I can't just throw away..."
- **Test**: If you had NOT already invested anything, would you start this same path today from scratch?

### Organized by Emotional Driver

| Emotion | What It Protects | Self-Deception Pattern | Red-Flag Phrase |
|---------|-----------------|----------------------|-----------------|
| **Fear** | Safety, status quo | Rationalizing inaction as prudence | "It's not the right time" |
| **Desire** | Wanting something | Rationalizing pursuit as rational | "I deserve this" |
| **Pride** | Self-image | Rationalizing refusal to admit error | "I was right all along, because..." |
| **Shame** | Avoiding pain | Rationalizing avoidance as choice | "I just don't want to" |
| **Comfort** | Current lifestyle | Rationalizing stasis as wisdom | "If it ain't broke..." |
| **Anger** | Ego, boundaries | Rationalizing retaliation as justice | "They had it coming" |
| **Attachment** | Relationships, possessions | Rationalizing holding on as loyalty | "I can't just give up on..." |

### Organized by Awareness Level

| Level | Internal Experience | Best Intervention |
|-------|-------------------|-------------------|
| **Fully blind** | Complete confidence. No doubt whatsoever. | External audit (Section E), or physical sensation check (Section D) |
| **Suspicious** | A nagging feeling. Slight discomfort when you explain your reasoning. | The Inversion Test (Section A, Step A5) |
| **Semi-aware** | You know something is off but actively avoid looking. You change the subject. | The Writing Test (Section A, Step A4) |
| **Caught** | You see it happening in real time but feel pulled to continue anyway. | The Commitment Device (Section B, Step B6) |

---

## STEP 3/6: ASSUMPTION EXTRACTION (/aex)

### Core Claims of the Standard Approach to Self-Deception Detection

**Claim 1: "You can catch your own self-deception through introspection."**

Assumptions:
- CAPABILITY: You can observe your own thinking accurately (Hiddenness: BURIED, Risk: CRITICAL)
  - This is the fundamental paradox. The thing doing the observing is the same thing doing the deceiving.
  - Mitigation built into procedure: Use EXTERNAL and MECHANICAL checks, not just introspection.
- KNOWLEDGE: You know what self-deception looks like (Hiddenness: Deep, Risk: High)
  - Mitigation: Procedure provides concrete checklists, not "reflect on your biases."
- VALUE: You actually WANT to catch yourself (Hiddenness: Buried, Risk: Critical)
  - If the self-deception is protecting you from something painful, you may unconsciously resist the procedure.
  - Mitigation: The procedure uses tests that work even if you are not fully willing.

**Claim 2: "Knowing about biases helps you avoid them."**

Assumptions:
- CAUSAL: Knowledge of bias leads to reduced bias (Hiddenness: BURIED, Risk: HIGH)
  - Research shows this is largely FALSE. Knowing about biases does not reliably reduce them. "Bias blind spot" -- people who know about biases are MORE confident they are unbiased.
  - Mitigation: Procedure relies on BEHAVIORAL tests (what you did), not COGNITIVE tests (what you think).
- STABILITY: Your ability to detect bias is constant (Hiddenness: Deep, Risk: High)
  - Actually, it degrades precisely when you need it most -- under emotional load.
  - Mitigation: Procedure front-loads the easiest checks and uses writing (slows you down).

**Claim 3: "If your reasoning is logical, it is not self-deceptive."**

Assumptions:
- CAUSAL: Logic = honest reasoning (Hiddenness: BURIED, Risk: CRITICAL)
  - This is the single most dangerous assumption. Self-deception often USES perfect logic -- applied to cherry-picked premises. The logic is valid; the premise selection is dishonest.
  - Mitigation: Procedure checks PREMISES and EVIDENCE GATHERING, not just logical structure.

**Claim 4: "You should always override self-deception."**

Assumptions:
- VALUE: Truth is always better than comfortable fiction (Hiddenness: Deep, Risk: Medium)
  - Sometimes self-deception serves a protective function (e.g., maintaining hope during terminal illness).
  - Mitigation: "When to Override" section addresses this.

### Priority Assumptions to Guard Against

1. **"I am the exception to bias"** -- The procedure must work WITHOUT requiring you to believe you are biased.
2. **"My reasoning feels careful, therefore it IS careful"** -- Feelings of carefulness are unreliable.
3. **"If I can explain my reasoning, it must be honest"** -- Rationalizations ARE explanations. That is the whole problem.
4. **"Strong emotion means the topic matters, but doesn't mean I'm biased"** -- Strong emotion is THE primary indicator of motivated reasoning.

---

## STEP 4/6: THE PROCEDURE (/stg)
...
**Action**: Before doing anything else, complete this sentence in writing (paper or digital):
...
**Action**: Close your eyes. Think about choosing the OPPOSITE of your current leaning. Notice what happens in your body for 10 seconds.
...
**Action**: Draw a line down the middle of a page. Label the left column "SUPPORTS my leaning" and the right column "CONTRADICTS my leaning."
...
**Action**: Write two paragraphs (minimum 4 sentences each):
...
**Action**: Answer each of these questions honestly and in writing:
...
- Any third or fourth options: **You are very likely engaged in motivated reasoning on this specific question.** The motivation is visible in your answer. Proceed to Step A6.
...
**Action**: Write answers to these questions:
...
**Action**: List every reason you give (or have given) for this decision. Number them.
...
**Action**: Complete this sentence three times, each time with a different ending:
...
**Action**: Imagine someone you consider foolish or biased made this exact same decision for these exact same stated reasons. Write down your reaction.
...
**If you would suspect them of rationalizing**: You should apply the same suspicion to yourself. The reasoning does not become more valid because you are the one doing it.

---

### Step B5: The Update Test

**Action**: Think of the single strongest piece of evidence or argument against your decision.
...
**Action**: Write down and share with one trusted person:
...
**Action**: Write down the last 3-5 times you ended up in this same type of situation. For each one, write the reason you gave at the time for why it was different or would work out.

---

### Step C2: Compare the Reasons

**Action**: Look at the reasons from C1. Highlight similarities.
...
**Action**: Answer: "What do I get to avoid, feel, or maintain by repeating this pattern?"
...
**Action**: Write down what you would do differently if you accepted that the pattern, not the circumstances, is the problem. What specific behavior would change?
...
**Action**: Pick the closest match from this list:
...
**Action**: Answer these three questions:
...
**Action**: For each reason you have given for your decision, classify it:
...
**Action**: Write down the conclusion the person (or past-you) reached.

---

### Step E2: Identify the Stated Reasons

**Action**: List every reason they gave.
...
**Action**: Can you construct a version of their reasoning that reaches the OPPOSITE conclusion using equally valid logic?
...
# FAILURE ANTICIPATION (from /fla analysis)

## Critical Failure Modes

### Failure 1: The Procedure Itself Becomes a Rationalization Tool
- **What happens**: Someone runs the procedure poorly or dishonestly, gets a low score, and uses it as "proof" they are being objective.
- **Risk**: HIGH (O: 7, S: 8, D: 8, RPN: 448)
- **How to detect**: The feeling of relief or vindication after running the procedure. Genuine self-examination usually produces discomfort, not comfort.
- **Mitigation**: The procedure explicitly warns about this (Mistake #2). Additionally, have someone else review your written answers.

### Failure 2: Emotional Flooding Makes the Procedure Unusable
- **What happens**: The person is in such a strong emotional state that they cannot honestly complete the exercises.
- **Risk**: HIGH (O: 6, S: 7, D: 6, RPN: 252)
- **How to detect**: Inability to write Paragraph 2 in Step A4. Skipping steps. Feeling that the procedure is "stupid."
- **Mitigation**: Step D2 explicitly tells people at 7+ to wait 24 hours. If waiting is impossible, have someone else run Section E on your behalf.

### Failure 3: The Person Lacks the Vocabulary to Describe Their Emotions
- **What happens**: Step D1 asks them to name an emotion. They say "fine" or "I don't know."
- **Risk**: MEDIUM (O: 5, S: 5, D: 7, RPN: 175)
- **How to detect**: Section D produces mostly blank or "Unsure" answers.
- **Mitigation**: The emotion table in D1 provides a menu. If still stuck, use the Body Check (A2) -- physical sensations bypass the need for emotional vocabulary.

### Failure 4: Confirmation Bias in the Evidence Audit
- **What happens**: In Step A3, the person unconsciously fills the SUPPORTS column with real evidence and the CONTRADICTS column with straw-man arguments.
- **Risk**: HIGH (O: 7, S: 6, D: 7, RPN: 294)
- **How to detect**: CONTRADICTS items are vague ("some people disagree") while SUPPORTS items are specific.
- **Mitigation**: Add a quality check: each item in CONTRADICTS must be as specific and sourced as items in SUPPORTS. If you cannot make them specific, you have not done enough research.

### Failure 5: Social Desirability -- Writing What You "Should" Think Rather Than What You Actually Think
- **What happens**: The person writes the "correct" answers rather than honest ones, especially in Step B3 (finding the real reason).
- **Risk**: MEDIUM (O: 6, S: 6, D: 8, RPN: 288)
- **How to detect**: All answers look like what a perfectly rational person would write. No discomfort, no surprises.
- **Mitigation**: The instruction to write what you would be "embarrassed to say out loud" is designed to bypass this. Additionally: do the procedure privately and destroy it after. Remove the audience.

## Monitoring Indicators

- **Leading indicator**: Discomfort during the procedure suggests honest engagement. Comfort suggests either genuine objectivity (rare) or performative completion.
- **Lagging indicator**: Decisions made after using the procedure produce fewer "I should have known" regrets over time.
- **Kill criterion**: If you find yourself unable to honestly complete ANY step, this is itself diagnostic -- the self-deception is strong enough to resist the detection procedure. Seek external input.

---

# PROCEDURE VALIDATION REPORT (/pv)

## Validation Results

| Dimension | Status | Notes |
|-----------|--------|-------|
| Completeness | PASS | All five situation types covered. Pre-decision, post-decision, pattern, emotional, and third-party. |
| Dependencies | PASS | Steps within each section are sequential and each depends only on outputs of prior steps. |
| Feasibility | PASS | Every step requires only paper/writing and honest reflection. No special tools or expertise. |
| Inputs | PASS | Only input required is the user's decision/situation and willingness to write. |
| Outputs | PASS | Every section terminates in a concrete verdict or action. No dead ends. |
| Consistency | PASS | No contradictions between sections. Cross-references are accurate. |

## Executability Check

| Step | Can a novice do it? | Ambiguity? | Resolution |
|------|---------------------|------------|------------|
| A1 (Write leaning) | Yes | No | -- |
| A2 (Body check) | Yes | Minor -- "what counts as a sensation?" | Checklist provided |
| A3 (Evidence audit) | Yes | Minor -- quality of evidence varies | Added quality note in Failure 4 |
| A4 (Writing test) | Yes | No | -- |
| A5 (Inversion test) | Yes | No | Multiple-choice format |
| A6 (Verdict) | Yes | No | Scoring table provided |
| B1-B6 | Yes | No | -- |
| C1-C5 | Yes | Minor -- "naming the pattern" is hard | Template sentence provided |
| D1-D4 | Yes | Minor -- emotion naming | Menu of emotions provided |
| E1-E5 | Yes | No | -- |

## Issues Found and Resolved

1. **Original Step A2 lacked a checklist** -- Resolved by adding specific sensation checklist.
2. **Original Step D1 assumed emotional vocabulary** -- Resolved by adding emotion category table.
3. **No guidance on what to do if procedure itself is gamed** -- Resolved by adding Failure Mode 1 and Mistake 2.
4. **No time estimates** -- Added: Section A takes approximately 30-45 minutes. Sections B-E take approximately 15-25 minutes each.

## Overall Status: VALID

The procedure is executable by someone with zero domain expertise. All paths lead to concrete outputs. Decision points are binary or explicit multiple choice. Writing-based format protects against the primary risk (introspection is unreliable; external records are harder to distort).

---

*Time estimates: Section A: 30-45 minutes. Sections B-E: 15-25 minutes each. Quick Reference Cards: 30 seconds for on-the-spot checks.*

*This procedure has not been validated by domain experts in psychology or cognitive science. It is based on established research on motivated reasoning, confirmation bias, and cognitive dissonance, but the specific procedure format is novel.*
