# DECIDING WHAT TO IGNORE: A Complete Decision Procedure
...
This is a mechanical, step-by-step procedure for deciding what information, concerns, objections, and possibilities to deliberately set aside when thinking through any problem, decision, or project. It is designed to be followed by someone with zero expertise in the domain they are working in.

Most thinking fails not from missing something important but from drowning in the unimportant. This procedure teaches the art of productive neglect -- knowing what to ignore so you can focus on what matters.
...
# DCP CHAIN STEP 1: DIMENSION DISCOVERY (/dd)

## Dimensions of "Deciding What to Ignore"

### Seed Examples

1. A startup founder ignoring competitor press releases to focus on customers
2. A doctor ignoring irrelevant lab values to focus on the presenting complaint
3. An editor cutting 40% of a manuscript to strengthen the remaining 60%
4. A project manager ignoring feature requests that do not serve the primary milestone
5. A researcher discarding 90% of search results to focus on the 10% with rigorous methodology
6. A chess player ignoring pawn structure to calculate a forcing tactical sequence
7. A homebuyer ignoring kitchen countertop material to focus on location and structure
8. An investor ignoring daily price movements to focus on quarterly earnings fundamentals

### Comparing for Differences

- Founder vs. Doctor: **Domain** differs, but both filter by relevance to the core objective. Dimension: **Relevance to Core Objective**.
- Editor vs. Project Manager: Editor removes content; PM defers requests. Dimension: **Reversibility** (can you bring it back later?).
- Researcher vs. Investor: Both use quality thresholds. Dimension: **Quality/Reliability of the Information**.
- Chess player vs. Homebuyer: Both ignore things that do not affect the outcome in the relevant timeframe. Dimension: **Time Horizon**.
- Founder vs. Researcher: Founder ignores for speed; researcher ignores for rigor. Dimension: **Purpose of Filtering** (speed vs. accuracy vs. clarity).

### Dimensions Discovered

| # | Dimension | Values | Why It Matters |
|---|-----------|--------|----------------|
| 1 | **Relevance** | Directly relevant / Tangentially relevant / Irrelevant | The most basic filter. Things unrelated to your actual goal can be cut first. |
| 2 | **Impact Magnitude** | High impact / Medium impact / Low impact / Negligible impact | Even relevant things may not change the outcome enough to justify attention. |
| 3 | **Reversibility** | Fully reversible / Partially reversible / Irreversible | You can safely ignore things you can revisit later. You cannot safely ignore things with permanent consequences. |
| 4 | **Time Sensitivity** | Urgent (expires soon) / Near-term / Long-term / No deadline | Items with no deadline can be deferred. Items about to expire need a quick keep-or-drop decision. |
| 5 | **Information Quality** | Verified/high quality / Unverified / Speculative / Known unreliable | Low-quality information is a candidate for ignoring unless it is the only signal you have. |
| 6 | **Controllability** | Fully in your control / Partially controllable / Completely outside your control | Things you cannot influence are often candidates for ignoring (with exceptions). |
| 7 | **Uniqueness of Signal** | Unique signal / Redundant with another item / Generic/common knowledge | If five data points all say the same thing, you can ignore four of them. |
| 8 | **Cost of Attention** | Free to consider / Moderate effort / Expensive (significant time/energy/resources) | Even important things may need to be ignored if the cost of engaging with them exceeds the value. |
| 9 | **Cost of Missing** | Catastrophic if ignored / Painful if ignored / Mildly inconvenient / No consequence | The asymmetry of ignoring: some things have low probability but catastrophic downside. |
| 10 | **Emotional Weight** | High emotional pull / Moderate / Low / None | Emotionally loud items demand attention disproportionate to their actual importance. This dimension helps you notice when emotion is the reason you are paying attention. |
| 11 | **Source Authority** | Expert/authoritative source / Peer/credible source / Unknown source / Known unreliable source | Who is saying it changes how much weight it deserves. |
| 12 | **Stage of Process** | Early exploration / Active decision-making / Execution / Post-decision review | What you should ignore changes depending on where you are in the process. |

**TOTAL SPACE**: 4 x 4 x 4 x 4 x 4 x 4 x 4 x 4 x 4 x 4 x 4 x 4 = ~16.7 million combinations
**GRANULARITY**: REPRESENTATIVE (we will use dimension-by-dimension with pruning)

### Independence Check

- Can Relevance vary while Impact stays constant? YES. Something can be highly relevant but low impact ("Yes, this applies to our situation, but it would only change the outcome by 1%").
- Can Reversibility vary while Time Sensitivity stays constant? YES. A reversible decision can still be time-sensitive.
- Can Emotional Weight vary independently of Impact Magnitude? YES. This is precisely the trap -- high emotion, low impact items steal attention.

All 12 dimensions are independent. Confirmed.

---

# DCP CHAIN STEP 2: SPACE ENUMERATION (/se)

## Options Per Dimension -- What You Might Be Considering Ignoring

### By Relevance
- **Directly relevant items**: Core factors that define the problem (e.g., price when buying a house)
- **Tangentially relevant items**: Related but not central (e.g., neighborhood restaurant scene when buying a house)
- **Irrelevant items**: Not connected to the decision (e.g., the real estate agent's shoe brand)

### By Impact Magnitude
- **High impact**: Changes the outcome by more than 25% or flips the decision entirely
- **Medium impact**: Changes the outcome by 5-25% or meaningfully shifts confidence
- **Low impact**: Changes the outcome by less than 5%
- **Negligible**: Makes no measurable difference regardless of direction

### By Reversibility
- **Fully reversible**: You can revisit this item at any time with no penalty (e.g., a feature you can add in v2)
- **Partially reversible**: You can revisit but at increased cost (e.g., a contract term you did not negotiate -- renegotiation is possible but harder)
- **Irreversible**: Once past this point, you cannot revisit (e.g., a one-time opportunity with a hard deadline)

### By Time Sensitivity
- **Expiring now**: Must decide in hours/days whether to engage
- **Near-term window**: Weeks to months before it becomes moot
- **Long-term**: Relevant for months or years, no urgency
- **Evergreen**: No deadline at all -- can be picked up or dropped at will

### By Information Quality
- **Verified**: Peer-reviewed, empirically tested, confirmed by multiple independent sources
- **Credible but unverified**: From a reliable source but not independently confirmed
- **Speculative**: Opinion, prediction, or theory without empirical backing
- **Known unreliable**: Source has track record of inaccuracy, or information has been debunked

### By Controllability
- **Fully controllable**: Your direct action determines the outcome (e.g., what you write in your application)
- **Partially controllable**: Your action influences but does not determine the outcome (e.g., how your interview goes)
- **Uncontrollable**: No action you take changes this factor (e.g., the macroeconomic environment)

### By Uniqueness of Signal
- **Unique signal**: This is the only source of this particular insight
- **Partially redundant**: Overlaps with other items but adds some unique angle
- **Fully redundant**: Says the same thing as another item you are already considering

### By Cost of Attention
- **Free**: Takes seconds to consider, no opportunity cost
- **Moderate**: Takes minutes to hours, displaces some other work
- **Expensive**: Takes days to investigate, significant opportunity cost

### By Cost of Missing (Downside Asymmetry)
- **Catastrophic**: Ignoring this could destroy the entire endeavor (safety issues, legal violations, single points of failure)
- **Painful**: Ignoring this will cause significant problems that require recovery
- **Mildly inconvenient**: Ignoring this causes small friction later
- **No consequence**: Ignoring this changes nothing

### By Emotional Weight
- **High emotional pull**: This item triggers fear, anger, excitement, or attachment
- **Moderate**: Some emotional resonance
- **Low/None**: Emotionally neutral

### Cross-Dimensional Interactions (Critical)

These interactions create the most important filtering rules:

| Combination | Rule |
|---|---|
| High Emotional Weight + Low Impact | **PRIME IGNORE CANDIDATE** -- emotion is inflating importance |
| Low Relevance + High Cost of Attention | **DEFINITE IGNORE** -- spending resources on the wrong problem |
| Irreversible + High Cost of Missing | **NEVER IGNORE** -- even if probability seems low |
| Fully Redundant + Any other dimension | **SAFE TO IGNORE** -- you already have this signal |
| Uncontrollable + Low Cost of Missing | **SAFE TO IGNORE** -- cannot change it and it does not matter |
| Uncontrollable + High Cost of Missing | **CANNOT IGNORE** -- must plan around it even if you cannot control it |
| Speculative Quality + High Impact | **INVESTIGATE BEFORE IGNORING** -- could matter but might be noise |

---

# DCP CHAIN STEP 3: ASSUMPTION EXTRACTION (/aex)

## Hidden Assumptions in Standard Approaches to Filtering

### Claim 1: "Focus on what matters and ignore the rest"

| Assumption | Type | Hiddenness | Risk if Wrong |
|---|---|---|---|
| You can tell what matters before investigating it | Knowledge | **BURIED** | HIGH -- the thing you dismissed as unimportant might be the key factor |
| "Mattering" is stable over time | Stability | Deep | MEDIUM -- what matters shifts as you learn more |
| The list of items is complete before filtering begins | Existence | Shallow | LOW -- you can always add items later |
| More focus automatically means better outcomes | Causal | Deep | MEDIUM -- sometimes scanning broadly is the right strategy |
| You are the right person to judge relevance | Capability | Deep | HIGH -- domain novices misjudge relevance constantly |

### Claim 2: "Use the 80/20 rule -- 20% of factors drive 80% of outcomes"

| Assumption | Type | Hiddenness | Risk if Wrong |
|---|---|---|---|
| Pareto distribution applies to this specific domain | Existence | **BURIED** | HIGH -- some domains have more evenly distributed importance |
| You can identify which 20% matters in advance | Knowledge | Deep | HIGH -- this is the entire problem |
| The 80% you ignore will not combine to outweigh the 20% you kept | Causal | **BURIED** | MEDIUM -- many small factors can dominate |
| The distribution is stable | Stability | Deep | MEDIUM -- importance shifts |

### Claim 3: "If in doubt, keep it -- you can always remove later"

| Assumption | Type | Hiddenness | Risk if Wrong |
|---|---|---|---|
| Keeping items is free | Resources | **BURIED** | HIGH -- attention is finite; every item you keep displaces focus |
| You will actually revisit and remove items later | Capability | Deep | HIGH -- most people never prune |
| Cognitive overload from too many items does less damage than missing one item | Value | **BURIED** | HIGH -- overload causes worse decisions across ALL items |

### Claim 4: "Trust your gut about what to ignore"

| Assumption | Type | Hiddenness | Risk if Wrong |
|---|---|---|---|
| Your intuition is calibrated to this domain | Knowledge | Deep | **CRITICAL** -- novice intuition in unfamiliar domains is unreliable |
| Emotional salience correlates with actual importance | Causal | **BURIED** | **CRITICAL** -- this is often backwards; emotional items are often distractors |
| Past pattern recognition applies to this new situation | Stability | Deep | HIGH -- if the situation is novel, patterns mislead |

### Priority Assumptions the Procedure Must Address

1. **You cannot tell what matters before investigating it** -- The procedure must provide a way to do quick, cheap investigation before committing to ignore. Never ignore based on first impression alone.

2. **Emotional salience does NOT correlate with importance** -- The procedure must explicitly separate emotional weight from analytical importance, because humans conflate these by default.

3. **Attention is finite and keeping everything is NOT free** -- The procedure must treat "keep" as a cost, not just "ignore" as a risk. Every item you keep dilutes focus on everything else.

4. **Novices misjudge relevance** -- The procedure must include external checks (asking someone with more domain knowledge) as an explicit step, not just internal judgment.

5. **Many small factors can combine to outweigh large ones** -- The procedure must include a step that checks whether discarded items, taken together, could change the outcome.

---

# DCP CHAIN STEP 4: THE PROCEDURE (/stg)
...
If you cannot write this sentence, you are not ready to triage. First clarify what you actually want (consider using /gu -- Goal Unpacking).
...
# DCP CHAIN STEP 5: FAILURE ANTICIPATION (/fla)

## Critical Failure Modes

| Failure Mode | Category | O | S | D | RPN | Tier |
|---|---|---|---|---|---|---|
| User cuts an item that turns out to be the most important factor | Process | 6 | 8 | 6 | 288 | CRITICAL |
| User keeps everything because they are afraid to cut | Human | 7 | 6 | 3 | 126 | HIGH |
| User confuses emotional importance with analytical importance | Human | 8 | 7 | 7 | 392 | CRITICAL |
| Triage criteria themselves are wrong (wrong core objective) | Input | 5 | 9 | 5 | 225 | CRITICAL |
| User applies procedure mechanically without understanding context | Human | 5 | 6 | 6 | 180 | HIGH |
| Time pressure causes user to skip verification steps (A3, A7) | Timing | 6 | 7 | 4 | 168 | HIGH |
| Aggregation of ignored items changes the outcome | Process | 4 | 7 | 7 | 196 | HIGH |

### Mitigations Built Into the Procedure

**For "cuts the most important factor" (RPN 288)**:
- Step A3 explicitly checks cuts for catastrophic downside
- Step A7 checks whether all cuts together could flip the decision
- Step A8 documents cuts so they can be reviewed later
- *Residual risk*: User's 10-second judgment in A2 is wrong. Mitigated by having three passes (A2, A3, A7) instead of one.

**For "confuses emotional with analytical importance" (RPN 392)**:
- The Two Critical Questions explicitly ask "Am I ignoring because it does not matter or because it is uncomfortable?"
- The When to Override section flags relief as a warning sign
- *Residual risk*: User does not honestly answer the self-reflection question. This cannot be fully mitigated by procedure alone -- it requires self-awareness.

**For "wrong core objective" (RPN 225)**:
- Step A1 requires writing the objective in one sentence
- Step A1 flags multi-part objectives ("and") as a problem
- *Residual risk*: User writes a clear but wrong objective. Mitigated by When to Override point 3 (seek expert input in unfamiliar domains).

### Contingency: What to Do If Triage Goes Wrong

**Trigger**: You made a decision using your triaged factors, and the outcome is bad.

**Immediate response**:
1. Pull out your documented cuts from Step A8/B5
2. Check: did any cut item predict this bad outcome?
3. If YES: you have identified a filtering error. Note which filter failed (relevance? impact? asymmetry check?) and adjust that filter's threshold for next time.
4. If NO: the bad outcome was caused by something not on ANY of your lists. Your triage was not the problem -- your initial factor identification was.

---

# DCP CHAIN STEP 6: PROCEDURE VALIDATION (/pv)

## Validation Report

| Dimension | Status | Notes |
|---|---|---|
| Completeness | PASS | All 5 triage types covered; all sections have entry, process, and exit criteria |
| Ordering | PASS | Steps within each section follow logical dependency order |
| Feasibility | PASS | Every step requires only writing, reading, and answering binary questions -- no special tools or expertise needed |
| Inputs | PASS | Only input required is a list of items to triage (procedure reminds user to write it down if not already done) |
| Outputs | PASS | Every section ends with a defined output (reduced list + documented cuts) |
...
1. **Issue**: Step A2 originally said "ask yourself" without specifying the question. *Resolution*: Added the specific question ("If I learned the answer to this factor right now, would it change my decision?").

2. **Issue**: Section B had no guidance on how to estimate probability for Risk-type objections. *Resolution*: Added the threshold (>20% probability AND >25% impact) and noted that exact estimates are not needed -- rough order of magnitude is sufficient.

3. **Issue**: Section E (Task Triage) originally used "important" without defining it relative to a specific goal. *Resolution*: Changed Question 2 to reference "your most important goal for this month" to make it concrete.

4. **Issue**: No guidance on when to re-run triage. *Resolution*: Added to Mistake 6: "Set a specific date to review your ignored items list."

5. **Issue**: The procedure could create a false sense of security ("I followed the steps, so my triage must be right"). *Resolution*: Added When to Override section and the contingency plan in failure anticipation to make clear this is a heuristic, not a guarantee.

**OVERALL VALIDATION STATUS: VALID -- Ready for use.**

---

*This procedure has not been validated by domain experts. It is a structured heuristic for general-purpose triage. For high-stakes decisions in specialized domains (medicine, law, finance, engineering), consult a qualified professional in addition to using this procedure.*
