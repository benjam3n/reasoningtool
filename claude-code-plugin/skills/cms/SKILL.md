...
## Overview
A structured procedure for evaluating multiple component options against
requirements, scoring them objectively, and selecting the best fit.
Produces documented rationale for the selection.
