...
## Application
1. Identify learning goal (recognition, recall, application, transfer?)
2. Choose ordering: higher-order goals need more interleaving and testing
3. Design practice schedule with spacing
4. Resist making it "easier" — desirable difficulty is the point
