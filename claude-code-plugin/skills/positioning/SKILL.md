...
3. Value delivered:
What do those attributes actually give customers?
...
5. Market category:
What frame of reference helps customers understand?
- Existing category you compete in
- Adjacent category you draw from
- New category you create

Positioning statement format:
"For [target customer] who [need/want], [product] is a
[category] that [key benefit]. Unlike [alternative],
...
Warning: Features that everyone has are not differentiators
Warning: What you think is unique may not matter to customers
...
Pros: Clear buyer, established budget
Cons: Compared to leaders, feature wars
...
Example: "Conversational marketing platform"
Pros: Own the category, no direct competition
Cons: Must explain and validate category
...
Pros: Clear differentiation, specific value
Cons: Smaller market, limited growth
...
Example: "The Slack for customer support teams"
Pros: Quick understanding, clear comparison
Cons: May be too limiting, depends on reference
...
Slack:
For teams who need to collaborate effectively,
Slack is a messaging platform
that brings all communication together.
Unlike email, Slack makes work communication
faster and more organized.

Stripe:
For internet businesses who need payments,
Stripe is a payment infrastructure
that handles complete commerce.
Unlike traditional payment processors,
Stripe provides developer-first tools that work globally.
