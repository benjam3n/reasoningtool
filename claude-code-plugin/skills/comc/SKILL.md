...
| Goal | Signal |
|------|--------|
| **Inform** | Audience needs to know something |
| **Persuade** | Audience needs to change their mind or agree |
| **Instruct** | Audience needs to do something specific |
| **Align** | Multiple parties need to reach shared understanding |
| **Inspire** | Audience needs motivation or energy |
