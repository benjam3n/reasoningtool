...
1. Brainstorm stakeholder categories:
   ...
   - Internal users of deliverables
   External:
...
1. For each stakeholder, assess:
   ...
   - What's their organizational influence?
   Attitude:
...
1. Identify items needing RACI:
   ...
   - Approval gates
2. For each item, assign roles:
   R - Responsible: Who does the work?
   A - Accountable: Who has final authority? (only one person)
   C - Consulted: Who must be consulted before decision? (two-way)
   I - Informed: Who must be told after decision? (one-way)
3. RACI rules:
...
1. For each stakeholder or stakeholder group, determine:
   ...
   - Based on project phase intensity
   What format:
   - Email updates
...
1. For each high-priority stakeholder, develop strategy:
   Current state:
