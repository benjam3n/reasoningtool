...
- Abstract: "In competitive systems, control key resources that enable
...
[Note disanalogies and their implications]
...
Hypothesis format:
"If [source principle] transfers to [target domain],
then we would expect [specific prediction]
because [mapping justification]"
