...
2. Indexing: Pages are analyzed and stored in database
3. Ranking: Algorithm determines order for each query
...
Understand that Google's goal is to surface the best answer
for every query. Your goal is to BE the best answer.
...
Create prioritized keyword list with rationale.
Aim for 10-20 priority keywords to start.
