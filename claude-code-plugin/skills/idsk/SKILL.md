...
| Verdict | Next Step |
|---------|-----------|
| Worth pursuing | Define smallest test and run it |
| Worth developing | Flesh out the details, find collaborators |
| Worth sharing | Write it up, get feedback from [specific audience] |
| Worth shelving | Record it clearly, revisit when [condition] changes |
