...
Liars optimize for the most obvious checks. Your ordering should prioritize what's hardest to fake, most independent, and least expected.
...
- **Why**: you can't detect anomalies without knowing what normal is
...
### Step 1: Define What You're Checking
