...
How much power do suppliers have over you?
...
How much power do customers have over you?
...
How easily could customers solve their problem differently?
...
1. SELECT MAPPING DIMENSIONS:
   Choose 2 dimensions most relevant to your market:
   - Price (low to high)
...
5. ALTERNATIVE VIEWS:
   Consider multiple maps with different dimensions to reveal
...
1. FORCE IMPACT SUMMARY:
   For each force, assess impact on profitability:
...
3. TREND ASSESSMENT:
   Is the industry becoming more or less attractive?
