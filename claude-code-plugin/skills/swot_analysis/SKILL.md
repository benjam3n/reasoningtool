...
For Strengths: Importance x Sustainability
For Weaknesses: Impact x Urgency
For Opportunities: Value x Probability x Time Sensitivity
For Threats: Impact x Probability x Proximity
