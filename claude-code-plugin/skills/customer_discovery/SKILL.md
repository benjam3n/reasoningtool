...
For each component, rate your confidence level (high/medium/low)
and identify what evidence would validate or invalidate it.
...
Listen for strong signals: they've tried to solve it, spending money,
frustrated with current solutions, ask when yours is available.
