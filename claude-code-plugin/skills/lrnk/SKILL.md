...
Use with:
- `/thnk` -> Choose the right thinking approach for what you're learning
- `/plsk` -> Turn the learning plan into a concrete schedule
- `/vldt` -> Validate your understanding at each milestone
- `/bldk` -> Learn by building something
