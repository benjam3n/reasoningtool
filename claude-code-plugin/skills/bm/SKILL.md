...
- Must answer: What specific outcome? Probability of success?
  Value if successful? Any cheaper alternative?
- Minimum 2:1 expected value ratio

LARGE ($30+):
- Critical path only - must be essential
- Must answer: Is goal achievable without this?
  What happens if we skip? Can we do cheaper version first?
- Written justification required
- Alternatives analysis required

Calculate Expected Value:
EV = P(success) x Value(if successful) - Cost
Decision: Proceed if EV > 0 and EV/Cost ratio > 2
